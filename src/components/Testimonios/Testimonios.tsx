  ...
  return (
    <div id="testimonios" className="w-full h-fit md:h-[500px] relative flex items-start px-3">
      ...
      <section className="w-full max-w-[1250px] mx-auto flex flex-col justify-center items-center md:flex-row gap-10 ">
        <article className="w-full md:w-1/2 flex flex-col gap-y-10 px-10 py-10">
        ...
        <article className="w-full md:w-1/2 mx-auto h-fit p-10 border-l-2 transition-all duration-100 border-mossGreen-500 bg-[#ACEED5]/10">
