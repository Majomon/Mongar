import { CardServices } from "@/interfaces";

const listServices: CardServices[] = [
  {
  ...
  },
  {
    ...
    title: "Rediseño Web",
    description: `Moderniza tu presencia online con un diseño innovador que refleje la esencia de tu marca y mejore la experiencia del usuario.`,
  },
  {
  ...
  },
  {
    ...
    title: "Catalogo",
    description: `Presenta tus productos o servicios de manera atractiva y organizada. Un catálogo digital que destaca tus ofertas y facilita la navegación para tus clientes.`,
  },
];
